...
namespace TGS
{
    ...
    {
        [Tooltip("Help")] [TextArea] public string info =
            "To load this configuration, just activate this component or call LoadConfiguration() method of this script.";

        [Tooltip("User-defined name for this configuration")] [TextArea]
        public string title = "Optionally name this configuration editing this text.";

        [HideInInspector] public string config;
